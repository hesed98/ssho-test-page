...
import background_card from '../img/카드@2x.png';
import istj_card from '../img/istj.jpg';
import istj_graph from '../img/istj.png';
import istj_style from '../img/istj_style.jpg';
import istj_rec_style from '../img/istj_rec_style.jpg';
import replay_button from '../img/replay.png';
import share_button from '../img/share.png';
    ...
    return (
      <div className="Landing_back">
        ...
        <div className="result_card">
            <img className="background_card" src={background_card} alt="background"></img>

            <img className="istj_card" src={istj_card} alt="istj"></img>
        ...
        <div className="result_container">
            <div className="result_description">
                ...
                <img className="istj_graph" src={istj_graph} alt="istj"></img>
                ...
                <h4>당신의 스타일</h4>
                <img className="istj_style" src={istj_style} alt="istj"></img>
                <h5>오피스룩</h5>
                <h4>추천 스타일</h4>
                <img className="istj_style" src={istj_rec_style} alt="istj"></img>
        ...
        <Link to ='/'><img className="button" src={replay_button} alt="replay button"></img></Link>
            <img className="button" src={share_button} alt="share button"></img>
        </div>
